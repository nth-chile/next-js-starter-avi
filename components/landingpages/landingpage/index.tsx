        ...
        <div>
          <div className="-mt-px flex divide-x divide-gray-200">
            ...
            <div className="-ml-px w-0 flex-1 flex">
              ...
              {
                !isEnabled && 
                  <a onClick={disableLandingPage} href="#" className="relative -mr-px w-0 flex-1 inline-flex items-center justify-center py-4 text-sm text-red-400 font-medium border border-transparent rounded-br-lg hover:text-gray-700">
                    <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              ...
              {
                isEnabled && 
                  <a onClick={disableLandingPage} href="#" className="relative -mr-px w-0 flex-1 inline-flex items-center justify-center py-4 text-sm text-green-400 font-medium border border-transparent rounded-br-lg hover:text-gray-700">
